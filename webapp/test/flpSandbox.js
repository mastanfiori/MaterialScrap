		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comnttdatasubzeroncfmaterialscrap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnttdatasubzeroncfmaterialscrap-display": {
								"semanticObject": "comnttdatasubzeroncfmaterialscrap",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.nttdata.subzero.ncfmaterialscrap",
									"url": sap.ui.require.toUrl("com/nttdata/subzero/ncfmaterialscrap")
								}
							}
						}
					}
